# -*- coding: utf-8 -*-
"""
Created on Fri Sep 20 16:17:28 2019
...
def create_timestamps(input_filename, output_filename):
    ...
    outputfile = io.open(output_filename, "w+", encoding="utf-8")
...
input_filename = r'C:\Users\anm16\Documents\default.ptu'
output_filename = r'C:\Users\anm16\Documents\default.txt'
create_timestamps(input_filename, output_filename)

timestamp_data = np.genfromtxt(output_filename, delimiter = ',', skip_header = 0)
timestamps = timestamp_data[:,3]
channels = timestamp_data[:,2]
y = np.diff(timestamps)
timestamps_filtered = y[(np.abs(y)<20000)]

plt.figure()
plt.hist(timestamps_filtered, bins = 1000)
print(' ')
print(np.round(std(timestamps_filtered),1))
