...
class Agilent33250a(object):
    ...
    def set_ramp(self, freq=1000, vpp=0.1, voffset=0, symmetry_percent = 100):
        # In a string, %0.6e converts a number to scientific notation like
        # print '%.6e' %(1234.56789) outputs '1.234568e+03'
        self.write('APPL:RAMP %0.6e HZ, %0.6e VPP, %0.6e V' % (freq,vpp,voffset))
        self.write('FUNC:RAMP:SYMM %s' % symmetry_percent)
