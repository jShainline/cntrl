...
class RigolDG5000(object):
    ...
    def set_burst_mode(self, burst_enable = True, num_cycles = 1, phase = 0, trigger_source = 'MAN', channel = 1):
        ...
        if   trigger_source.upper() == 'INT': self.write(':SOUR%s:BURS:TRIG:SOUR INT' % channel)
